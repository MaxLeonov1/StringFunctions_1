...
int main() {
    ...
    char*       test_str_3     = (char*)malloc( str_2_len * sizeof(char));
    ...
    printf ( "old: %p\n", test_str_3);
    printf ( "scaned: %d\n", my_getline( &test_str_3, &str_2_len, test_file_1));
    printf ( "str_new: %s", test_str_3);
    printf ( "new: %p, %d\n", test_str_3, my_strlen(test_str_3));
